...
def generate_requirements_file_for_sagemaker_training_jobs(toml_file: str, keys: List[str], output_path: str):
...
if __name__ == "__main__":
    generate_requirements_file_for_sagemaker_training_jobs("./pyproject.toml", ["avalanche", "benchmark", "dev"], "test/integration_tests")
