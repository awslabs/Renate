...
def test_init(model_name):
    HuggingFaceSequenceClassificationTransformer(pretrained_model_name=model_name, num_outputs=10)
...
def test_text_transformer_fwd(model_name, input_dim):
    transformer = HuggingFaceSequenceClassificationTransformer(pretrained_model_name=model_name)
