...
@pytest.mark.parametrize(
    ...
    [
        ...
        [PromptedVisionTransformer, "prompt_embedding_features", "not_cls", AssertionError],
        [PromptedVisionTransformer, "patch_pooler", "not_cls", AssertionError],
    ],
)
def test_pool_vision_transformer_raises_errors(cls, arg, argval, error):
    ...
    #     PromptPool(similarity_fn="not_cosine")

    # with pytest.raises(AssertionError):
    #     PromptedVisionTransformer(prompt_embedding_features="notcls")

    # with pytest.raises(AssertionError):
    #     PromptedVisionTransformer(patch_pooler="notcls")
...
def test_prompt_vision_transformer_trainable_parameters(backbone, num_trainable_params):
    ...
    model = PromptedVisionTransformer(pretrained_model_name_or_path=backbone)
