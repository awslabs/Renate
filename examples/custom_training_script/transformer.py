...
class HFSequenceClassificationTransformer(RenateModule):
...
class HFSequenceClassificationTransformerWithLora(
    HFSequenceClassificationTransformer
):
...
class HFSequenceClassificationTransformerWithPrefixTuning(
    HFSequenceClassificationTransformer
):
...
class HFSequenceClassificationTransformerWithPromptTuning(
    HFSequenceClassificationTransformer
):
...
class HFSequenceClassificationTransformerWithPTuning(
    HFSequenceClassificationTransformer
):
